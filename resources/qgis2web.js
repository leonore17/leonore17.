...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [688333.000000, 6562601.000000, 1011639.000000, 6811154.500000],
            units: 'm'
        })
    })
});
...
map.getView().fit([721840.988502, 6544293.841927, 1162978.979889, 6811224.473657], map.getSize());
